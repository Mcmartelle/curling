...
var $MacCASOutreach$graphicsvg$GraphicSVG$getAlpha = function (colour) {
	return $avh4$elm_color$Color$toRgba(colour).B;
};
...
var $MacCASOutreach$graphicsvg$GraphicSVG$App$hiddenTickUpdate = F3(
	function (userUpdate, msg, _v0) {
		...
		switch (msg.$) {
			...
			case 2:
				var t = msg.a;
				var timeInSeconds = A2($MacCASOutreach$graphicsvg$GraphicSVG$App$subtractTimeSeconds, t, hiddenModel.F);
				var keyChecker = $MacCASOutreach$graphicsvg$GraphicSVG$App$keyCheckerFunction(hiddenModel.e);
				var wasd = A5(
				...
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							hiddenModel,
							{
								e: $MacCASOutreach$graphicsvg$GraphicSVG$App$maintainKeyDict(hiddenModel.e)
							})),
					A2($elm$core$Platform$Cmd$map, $MacCASOutreach$graphicsvg$GraphicSVG$App$UserMsg, newUserCmds));
			case 3:
				var keyCode = msg.a;
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							hiddenModel,
							{
								e: A3($MacCASOutreach$graphicsvg$GraphicSVG$App$insertKeyDict, hiddenModel.e, keyCode, 1)
							})),
					$elm$core$Platform$Cmd$none);
			case 4:
				var keyCode = msg.a;
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							hiddenModel,
							{
								e: A3($MacCASOutreach$graphicsvg$GraphicSVG$App$insertKeyDict, hiddenModel.e, keyCode, 0)
							})),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
...
var $author$project$Main$Lose = 3;
var $author$project$Main$Wait = 1;
var $author$project$Main$Win = 2;
var $author$project$Main$arenaHeight = 800;
var $author$project$Main$arenaWidth = 420;
var $author$project$Main$force = 5;
var $author$project$Main$friction = 1;
var $author$project$Main$hogglinje = 0;
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$Main$stoneRadius = 20;
var $author$project$Main$targetDistance = 300;
var $author$project$Main$targetRadius = 30;
var $author$project$Main$tooFar = ($author$project$Main$targetDistance + $author$project$Main$stoneRadius) + $author$project$Main$targetRadius;
...
var $MacCASOutreach$graphicsvg$GraphicSVG$alignLeft = function (stencil) {
	if (stencil.$ === 7) {
		...
		return A2(
			...
			A8($MacCASOutreach$graphicsvg$GraphicSVG$Secret$Face, si, bo, i, u, s, sel, f, 0),
			str);
	} else {
		var a = stencil;
		return a;
...
var $author$project$Main$buttonColor = A4($MacCASOutreach$graphicsvg$GraphicSVG$rgba, 64, 64, 64, 1);
...
var $author$project$Main$dark = A4($MacCASOutreach$graphicsvg$GraphicSVG$rgba, 10, 10, 10, 1);
...
var $author$project$Main$statusX = -200;
var $author$project$Main$statusY = $author$project$Main$hogglinje + 10;
				...
				$MacCASOutreach$graphicsvg$GraphicSVG$group(
					_List_fromArray(
						[
										...
										A2(
											...
											$MacCASOutreach$graphicsvg$GraphicSVG$centered(
												A2(
													...
													14,
													$MacCASOutreach$graphicsvg$GraphicSVG$text('Hide Speed')))))),
									A2(
									$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
									$author$project$Main$ToggleShowSpeed,
									A2(
										$MacCASOutreach$graphicsvg$GraphicSVG$move,
										_Utils_Tuple2(150, -47),
										A2(
											$MacCASOutreach$graphicsvg$GraphicSVG$filled,
											$MacCASOutreach$graphicsvg$GraphicSVG$white,
											$MacCASOutreach$graphicsvg$GraphicSVG$centered(
												A2(
													$MacCASOutreach$graphicsvg$GraphicSVG$size,
													12,
													$MacCASOutreach$graphicsvg$GraphicSVG$text('(hard mode)'))))))
								])) : $MacCASOutreach$graphicsvg$GraphicSVG$group(
							_List_fromArray(
								[
									A2(
										...
										A2(
											...
											$MacCASOutreach$graphicsvg$GraphicSVG$centered(
												A2(
													$MacCASOutreach$graphicsvg$GraphicSVG$size,
													14,
													$MacCASOutreach$graphicsvg$GraphicSVG$text('Show Speed')))))),
									A2(
									$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
									$author$project$Main$ToggleShowSpeed,
									A2(
													...
													$MacCASOutreach$graphicsvg$GraphicSVG$alignLeft(
														$MacCASOutreach$graphicsvg$GraphicSVG$bold(
															A2(
																$MacCASOutreach$graphicsvg$GraphicSVG$size,
																16,
																$MacCASOutreach$graphicsvg$GraphicSVG$text('Push the stone')))))),
												A2(
												$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
							...
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$move,
							_Utils_Tuple2(0, $author$project$Main$targetDistance),
							A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$filled,
								$MacCASOutreach$graphicsvg$GraphicSVG$red,
							...
							A2(
								...
								$MacCASOutreach$graphicsvg$GraphicSVG$circle($author$project$Main$stoneRadius)))
						])))
			]));
};
